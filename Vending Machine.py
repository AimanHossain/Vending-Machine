...
products = [
    ...
    {"name": "Coca-Cola", "code": "A1", "price": 1.50, "quantity": 10},
    
    {"name": "Pepsi", "code": "A2", "price": 1.50, "quantity": 10},
    
    {"name": "Sprite", "code": "A3", "price": 1.50, "quantity": 10},
    
    {"name": "Fanta", "code": "A4", "price": 1.50, "quantity": 10},
    
    {"name": "Lays Chips", "code": "B1", "price": 0.75, "quantity": 10},
    
    {"name": "Doritos", "code": "B2", "price": 0.75, "quantity": 10},
    
    {"name": "Cheetos", "code": "B3", "price": 0.75, "quantity": 10},
    
    {"name": "Pringles", "code": "B4", "price": 0.75, "quantity": 10},
]
